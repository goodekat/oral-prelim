...
- Teaching assisstant at UW Madison
...
- Led to research area of explainable machine learning 
  ...
  - Method overview papers/books: .medium[`r Citep(myBib, c("gilpin:2018", "guidotti:2018", "ming:2017", "mohseni:2018", "molnar:2019", "samek:2019"))`].

- European General Data Protection Regulation (GDPR) implemented in 2018 includes a "right to explanation"

  > `r Citet(myBib, "goodman:2016")`: "It is reasonable to suppose that any adequate explanation would, at a minimum, provide an account of how input features relate to predictions, allowing one to answer questions such as: Is the model more or less likely to recommend a loan if the applicant is a minority?"

---

# Explainability versus Interpretability

No accepted definitions for explainability and interpretability .medium[`r Citep(myBib, c("gilpin:2018", "lipton:2016", "molnar:2019", "montavon:2017", "murdoch:2019"))`]  

My definitions .medium[(implicity used by `r Citet(myBib, "rudin:2018")` and `r Citet(myBib, "ribeiro:2016")`)]:
...
- LIME: local interpretable model-agnostic explanations `r Citep(myBib, "ribeiro:2016")`
...
.pull-left[
**General Model Visualizations**: .blue[Strategies for understanding any model]

.medium[
- Removing the blindfold .small[`r Citep(myBib, "wickham:2015")`]
]

**Global Methods**: .blue[Explaination for model as a whole]

.medium[
- Partial dependence plots .small[`r Citep(myBib, "friedman:2001")`] and extensions:
  - Interactive partial dependence plots .small[`r Citep(myBib, "krause:2016")`]
  - Individual conditional expectation plots .small[`r Citep(myBib, "goldstein:2013")`]
  - Accumulated local effect plots .small[`r Citep(myBib, "apley:2016")`]
  - Feature interaction plots .small[`r Citep(myBib, c("friedman:2008", "greenwell:2018", "hooker:2004"))`]
- Global feature importance plots .small[`r Citep(myBib, c("fisher:2018", "altmann:2010", "casalicchio:2019"))`]
- Global surrogate models .small[`r Citep(myBib, "molnar:2019")`]
]
...
.pull-left[
**Local Methods**: .blue[Explanation for an individual prediction]

.medium[
- Individual conditional importance plots .small[`r Citep(myBib, "casalicchio:2019")`]
- LIME .small[`r Citep(myBib, "ribeiro:2016")`]
- Anchors (scoped rules) .small[`r Citep(myBib, "ribeiro:2018")`]
- Shapely values .small[`r Citep(myBib, "štrumbelj:2014")`]
- SHAP .small[`r Citep(myBib, "lundberg:2017")`]
- breakDown .small[`r Citep(myBib, "staniak:2018")`]
]

**Example Based**: .blue[Explanations based on examples from the data]

.medium[
- Counterfactual examples .small[`r Citep(myBib, c("wachter:2017", "martens:2014", "looveren:2019", "laugel:2017"))`]
- Adversarial examples .small[`r Citep(myBib, c("szegedy:2013", "goodfellow:2014", "biggio:2018", "su:2019"))`]
- Prototypes and criticisms .small[`r Citep(myBib, "kim:1016")`]
- Influential instances .small[`r Citep(myBib, "koh:2017")`]
]
]
...
.medium[
- Random forest impurity based feature importance .small[`r Citep(myBib, "breiman:2001")`]
- Sectioned scatterplots .small[`r Citep(myBib, "urbanek:2008")`]
- Trace plots of trees .small[`r Citep(myBib, "urbanek:2008")`]
- Simplified model .small[`r Citep(myBib, "hara:2016")`]
- Forest floor visualizations .small[`r Citep(myBib, "welling:2016")`]
- Interactive visualizations .small[`r Citep(myBib, c("beckett:2018", "dasilva:2017"))`]
]

**Neural Networks**

.medium[
- Extracting tree structures .small[`r Citep(myBib, "craven:1996")`]
- Saliency maps .small[`r Citep(myBib, "simonyan:2013")`]
- Feature visualization .small[`r Citep(myBib, "olah:2017")`]
- Grand tours .small[`r Citep(myBib, "li:2020")`]
- Flows .small[`r Citep(myBib, "halnaut:2020")`]
]
]
...
.red[Arguement against black box model explanations] `r Citep(myBib, "rudin:2018")`:
...
.red[Assessment of LIME] `r Citep(myBib, "laugel:2018")`:
  - How to choose a local region?
  
.red[Assessment of counterfactual examples] `r Citep(myBib, "laugel:2018")`:
  - Issues with unjustified counterfactual examples

.red[Assessment of saliency maps] `r Citep(myBib, "kindermans:2017")`:
...
`r Citet(myBib, "hare:2016")` approach: 
  - Random forest model
...
**Result**: Unreasonable explanations (LIME explanation does not agree with random forest prediction)

**Example**: Known non-match

```{r fig.width = 7, fig.height = 5, out.width = "65%", message = FALSE, fig.align = "center"}
# Load the hamby data
...
.pull-left[LIME `r Citep(myBib, "ribeiro:2016")`:
...
Claims made about LIME `r Citet(myBib, "ribeiro:2016")`:
...
.tiny[Image source: https://en.wikipedia.org/wiki/Artificial_neural_network]
]
...
Visualizations of the paths of an observation through the network
  - Example: flow `r Citep(myBib, "halnaut:2020")`
